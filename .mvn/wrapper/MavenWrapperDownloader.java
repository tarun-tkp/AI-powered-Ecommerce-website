...
public class MavenWrapperDownloader {
    ...
    /**
     * Name of the property which should be used to override the default download url for the wrapper jar.
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            if (httpClient.getResponseCode() != HttpURLConnection.HTTP_OK) {
                System.out.println(" - ERROR: Server returned HTTP response code: " + httpClient.getResponseCode());
                System.exit(1);
            }
        } catch (IOException e) {
        ...
        try {
            ...
            System.out.println("- Error downloading from " + url + " to " + outputFile.getAbsolutePath());
            System.exit(1);
        }
        System.exit(0);
    }
